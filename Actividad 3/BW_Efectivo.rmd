...
Tomando como referencia los siguientes parámetros se obtiene:
...
Se obtiene una mejor aproximación con el modelo frantal browniano para la traza de datos ya que el valor del ancho de banda efectivo de la traza es superior a la taza promedio de arribo.
...
##Análisis Estadístico de Tráfico Agregado
###Tráfico agregado de video MPEG
La generación de la agregación consiste en diferentes copias desfasadas de la secuencia de video original. 
